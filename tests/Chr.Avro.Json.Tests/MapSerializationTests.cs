...
namespace Chr.Avro.Serialization.Tests
{
    public class MapSerializationTests
    {
        ...
        public void IImmutableDictionaryValues(Dictionary<string, double> value)
        {
            ...
            using (_stream)
            {
                serialize(value.ToImmutableDictionary(), new Utf8JsonWriter(_stream));
            }
        ...
        public void ImmutableSortedDictionaryValues(Dictionary<string, double> value)
        {
            ...
            using (_stream)
            {
                serialize(value.ToImmutableSortedDictionary(), new Utf8JsonWriter(_stream));
            }
        ...
        public void SortedDictionaryValues(Dictionary<string, double> value)
        {
            ...
            using (_stream)
            {
                serialize(new SortedDictionary<string, double>(value), new Utf8JsonWriter(_stream));
            }
        ...
        public void SortedListValues(Dictionary<string, double> value)
        {
            ...
            using (_stream)
            {
                serialize(new SortedList<string, double>(value), new Utf8JsonWriter(_stream));
            }
