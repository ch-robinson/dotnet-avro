namespace Chr.Avro.Tests
{
    ...
    public abstract class TypeResolverShould
    {
        protected abstract TypeResolver Resolver { get; }
        ...
        [InlineData(typeof(int[][]), typeof(int[]), false)]
        public void ResolveArrays(Type type, Type itemType, bool isNullable)
        {
        ...
        public void ResolveBooleans(Type type, bool isNullable)
        {
        ...
        public void ResolveByteArrays(Type type, bool isNullable)
        {
        ...
        [Fact]
        public void ResolveClassesWithNoFields()
        {
        ...
        public void ResolveDecimals(Type type, bool isNullable, int precision, int scale)
        {
        ...
        public void ResolveDurations(Type type, bool isNullable, double precision)
        {
        ...
        public void ResolveEnumsWithDuplicateValues(Type type, bool isNullable)
        {
        ...
        public void ResolveEnumsWithExplicitValues(Type type, bool isNullable)
        {
            var resolution = Resolver.ResolveType(type) as EnumResolution;
        ...
        public void ResolveEnumsWithImplicitValues(Type type, bool isNullable)
        {
            var resolution = Resolver.ResolveType(type) as EnumResolution;
        ...
        public void ResolveEnumsWithNoSymbols(Type type, bool isNullable)
        {
            var resolution = Resolver.ResolveType(type) as EnumResolution;
        ...
        public void ResolveFlagEnumsWithDefaultUnderlyingType(Type type, Type underlyingType, bool isNullable)
        {
            var resolution = Resolver.ResolveType(type) as EnumResolution;
        ...
        public void ResolveFlagEnumsWithOtherUnderlyingTypes(Type type, Type underlyingType, bool isNullable)
        {
            var resolution = Resolver.ResolveType(type) as EnumResolution;
        ...
        public void ResolveFloatingPoints(Type type, bool isNullable, int size)
        {
        ...
        public void ResolveIntegers(Type type, bool isNullable, bool isSigned, int size)
        {
        ...
        [Fact]
        public void ResolveInterfacesWithNoFields()
        {
        ...
        public void ResolveMaps(Type type, Type keyType, Type valueType, bool isNullable)
        {
        ...
        [Fact]
        public void ResolvePublicClassFieldsAndProperties()
        {
        ...
        [Fact]
        public void ResolvePublicInterfaceProperties()
        {
        ...
        public void ResolveStrings(Type type, bool isNullable)
        {
        ...
        public void ResolveStructsWithNoFields(Type type, bool isNullable)
        {
        ...
        public void ResolveTimestamps(Type type)
        {
        ...
        public void ResolveUris(Type type, bool isNullable)
        {
        ...
        public void ResolveUuids(Type type, bool isNullable, int variant, int version)
        {
