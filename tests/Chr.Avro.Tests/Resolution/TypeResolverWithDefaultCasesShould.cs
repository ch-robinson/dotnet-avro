namespace Chr.Avro.Tests
{
    ...
    public class TypeResolverWithDefaultCasesShould : TypeResolverShould
    {
        protected override TypeResolver Resolver => new ();

        [Fact]
        public void ResolveClassesWithDataContractAttributes()
        {
            ...
            Assert.Equal("chr.fixtures", resolution.Namespace.Value);
        ...
        [Fact]
        public void ResolveClassesWithNonSerializedMemberAttributes()
        {
        ...
        public void ResolveEnumsAsUnderlyingIntegralTypes(Type type, bool isNullable, bool isSigned, int size)
        {
            var resolver = new TypeResolver(resolveUnderlyingEnumTypes: true);
        ...
        public void ResolveEnumsWithDataContractAttributes(Type type, bool isNullable)
        {
        ...
        public void ResolveEnumsWithNonSerializedSymbolAttributes(Type type, bool isNullable)
        {
            var resolution = Resolver.ResolveType(type) as EnumResolution;
        ...
        public void ResolveReferenceTypesAsNullable(Type type)
        {
            var resolver = new TypeResolver(resolveReferenceTypesAsNullable: true);
