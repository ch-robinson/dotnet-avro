...
export default () =>
  <>
    ...
    <Highlight language='shell'>{`$ dotnet tool install Chr.Avro.Cli --global --version 1.0.0-rc.0
Tool 'chr.avro.cli' (version '1.0.0-rc.0') was successfully installed.`}</Highlight>
