...
export default () =>
  <>
    ...
    <Highlight language='shell'>{`$ dotnet tool install Chr.Avro.Cli --global --version 1.0.0-rc.5
Tool 'chr.avro.cli' (version '1.0.0-rc.5') was successfully installed.`}</Highlight>
