    ...
    public class JsonDurationDeserializerBuilderCase : DurationDeserializerBuilderCase, IJsonDeserializerBuilderCase
    {
        ...
        public virtual JsonDeserializerBuilderCaseResult BuildExpression(TypeResolution resolution, Schema schema, JsonDeserializerBuilderContext context)
        {
            if (schema.LogicalType is DurationLogicalType)
            {
                ...
                {
                    return JsonDeserializerBuilderCaseResult.FromException(new UnsupportedTypeException(resolution.Type, $"{nameof(JsonDurationDeserializerBuilderCase)} can only be applied to {nameof(DurationResolution)}s."));
                }
            }
            else
            {
