namespace Chr.Avro.Serialization
{
    ...
    /// <summary>
    /// Provides a base implementation for serializer builder cases that match <see cref="UnionSchema" />.
    /// </summary>
    public class UnionSerializerBuilderCase : SerializerBuilderCase
    {
        /// <summary>
        ...
        /// </param>
        /// <returns>
        /// A <see cref="Type" /> to build the child serializer with. <paramref name="type" /> must
        /// be assignable from the returned <see cref="Type" />.
        /// </returns>
